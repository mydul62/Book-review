...
const Banner = () => {
  ...
  <div className="flex items-center flex-col justify-between lg:flex-row-reverse px-0 md:px-[120px]">
    <img src="/bnrbk.png" className=" md:max-w-sm " />
    <div  className=" w-[100%] md:w-[50%] md:space-y-12 mt-6 md:mt-0">
      <h1 className="text-[35px] md:text-[56px]  font-bold font-Playfair ">Books to freshen up your bookshelf</h1>
